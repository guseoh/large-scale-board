...
public class CommentService {
    ...
    public CommentService(CommentRepository comments, ArticleService articles, MemberService members) {
    ...
    @Transactional
    public CommentResponse create(Long articleId, String username, CommentRequest.Create request) {
    ...
    @Transactional
    public CommentResponse update(Long id, String username, CommentRequest.Update request) {
